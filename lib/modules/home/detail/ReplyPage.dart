        ...
        children: <Widget>[
          new Container(
            child: new FlatButton.icon(
              ...
              icon: new Icon(Icons.arrow_back, color: Config.fontColor),
              label: new Text(""),
            ),
            width: 60.0,
          ),
          ...
          new Container(
            child: new IconButton(icon: new Icon(Icons.share, color: Config.fontColor), onPressed: (){}, padding: const EdgeInsets.all(0.0), iconSize: 18.0),
          ),
          new Container(
            child: new IconButton(icon: new Icon(Icons.list, color: Config.fontColor), onPressed: (){}, padding: const EdgeInsets.all(0.0), iconSize: 18.0),
          ),
        ],
      ),
              ...
              children: <Widget>[
                new Container(
                  child: new FlatButton(
                    ...
                    child: new Container(
                      child: new Text("你认为《三体》中最牛的文明是？", style: new TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0, height: 1.3, color: Config.dark == true? Colors.white70 : Colors.black)),
                ...
                new Container(
                  child: new Text(
                      ...
                      style: new TextStyle(height: 1.4, fontSize: 16.0, color: Config.fontColor), textAlign: TextAlign.start
                  ),
          ...
          bottomNavigationBar: new BottomAppBar(
              child: new Container(
                ...
                child: new Row(
                  children: <Widget>[
                    new Container(
                      child: new FlatButton.icon(onPressed: (){}, label: new Text("赞同 10 K"), color: Config.searchBackgroundColor, icon: new Icon(Icons.arrow_drop_up),),
                          ...
                          children: <Widget>[
                            new IconButton(
                                ...
                                icon: new Container(
                                  child: new Column(
                                    children: <Widget>[
                                      new Icon(Icons.favorite, size: 18.0, color: Config.fontColor,),
                                      new Text("感谢", style: new TextStyle(fontSize: 10.0, color: Config.fontColor),)
                                    ],
                                  ),
                            ...
                            new IconButton(
                                ...
                                icon: new Container(
                                  child: new Column(
                                    children: <Widget>[
                                      new Icon(Icons.star, size: 18.0, color: Config.fontColor,),
                                      new Text("收藏", style: new TextStyle(fontSize: 10.0, color: Config.fontColor),)
                                    ],
                                  ),
                                  margin: const EdgeInsets.only(),
                                  height: 30.0,
                            ...
                            new IconButton(
                                ...
                                icon: new Container(
                                  child: new Column(
                                    children: <Widget>[
                                      new Icon(Icons.mode_comment, size: 18.0, color: Config.fontColor,),
                                      new Text("345", style: new TextStyle(fontSize: 10.0, color: Config.fontColor),)
                                    ],
                                  ),
                                  margin: const EdgeInsets.only(),
                                  height: 30.0,
